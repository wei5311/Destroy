...
Infi.prototype.move = function(){
	...
	if (this.topPos > -20 && this.topPos < 0) {
...
Block.prototype.gameTime = function() {
	...
	var speed = null;
	switch(true) {
		case _this.sco < 30: speed = 1.7; break;
		case _this.sco < 60: speed = 2; break;
		case _this.sco < 90: speed = 2.2; break;
		case _this.sco < 140: speed = 2.3; break;
		case _this.sco < 200: speed = 2.4; break;
		case _this.sco < 300: speed = 2.5; break;
		case _this.sco < 400: speed = 2.6; break;
		case _this.sco < 500: speed = 2.7; break;
		case _this.sco < 600: speed = 2.8; break;
		case _this.sco < 700: speed = 3; break;
		case _this.sco < 800: speed = 3.2; break;
		case _this.sco >= 800: speed = 3.4; break;
	}
 	...
 	if (nowPlay == 2) {
		...
		if (edition.length > 10) {
			for (var i = 0; i < 10; i++) {
				...
				var num = i + 1;
				$(".list-show li").eq(i).html("第" + num + "名:" + "  " + edition[i] + "分");
			};
		} else {
		...
		if (ordinary.length > 10) {
			for (var i = 0; i < 10; i++) {
				$(".list-show ul").append("<li></li>");
				var num = i + 1;
				$(".list-show li").eq(i).html("第" + num + "名:" + "  " + ordinary[i] + "分");
			};
		} else {
